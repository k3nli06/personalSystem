...
public record PersonalDto(Long id, String name, String email, String password, DepartmentDto department,
        List<RoleDto> role, String workstation) {
    ...
    public static Personal toEntity(PersonalDto personalDto) {
        ...
        var personal = new Personal(personalDto.id(), personalDto.name, personalDto.email, null,
                DepartmentDto.toEntity(personalDto.department), personalDto.workstation);
